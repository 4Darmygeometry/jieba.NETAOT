...
namespace JiebaNet.Segmenter.Common
{
    ...
    {
        private static readonly Regex RegexDigits = new Regex(@"\d+", RegexOptions.Compiled, RegexDefaults.MatchTimeout);
        private static readonly Regex RegexNewline = new Regex("(\r\n|\n|\r)", RegexOptions.Compiled, RegexDefaults.MatchTimeout);
